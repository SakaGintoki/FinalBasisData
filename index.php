    ...
    <header class="header">
        ...
        <div class="popup-overlay" id="popupOverlay">
            <div class="popup" id="authPopup">
                ...
                <form method="post" action="" id="authForm">
                    ...
                    <input type="hidden" name="auth_type" value="Sign In" id="authType">
                    <button type="submit" class="btn" id="actionBtn">Sign In</button>
                </form>
                <p class="switch-btn" id="switchMode" onclick="switchAuthMode()">Switch to Sign Up</p>
                <p class="close-btn" id="closePopup" onclick="closePopup()">Close</p>
            </div> 
        </div>
        ...
        <script>
            ...
            switchMode.addEventListener('click', () => {
                ...
                authType.value = isSignIn ? 'Sign In' : 'Sign Up'; // Ubah nilai auth_type
            });
        ...
        <div class="author-content">
            ...
            <div class="navbar-author">
                ...
                <div class="icon">
                    ...
                    <img src="WhatsApp Image 2024-12-06 at 21.51.06_20aa3683.jpg" >
                    <div class="social-media">
                        <a href="#" id="facebook"> <i class='bx bxl-facebook' ></i> </a>
                        <a href="#" id="twitter"> <i class='bx bxl-twitter' ></i> </a>
                        <a href="#" id="instagram"> <i class='bx bxl-instagram-alt' ></i> </a>
                ...
                <div class="icon">
                    ...
                    <img src="Screenshot 2024-12-06 215202.png">
                    <div class="social-media">
                        <a href="#" id="facebook"> <i class='bx bxl-facebook' ></i> </a>
                        <a href="#" id="twitter"> <i class='bx bxl-twitter' ></i> </a>
                        <a href="#" id="instagram"> <i class='bx bxl-instagram-alt' ></i> </a>
